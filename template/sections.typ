...
Für diese Arbeit wird das Template `vienna-tech` verwendet, die
auf den Stil der LaTeX Klasse `BachelorBUI.cls` aufbaut, welche auf der TU Website zu finden ist #link("https://www.tuwien.at/cee/edvlabor/lehre/vorlagen").
